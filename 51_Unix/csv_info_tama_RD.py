...
print(" [@_T] ■■ [/csv_info_tama_RD.py] ==> [T_02] [ob_sort]"+ str(ob_sort) )
...
for i in table_list:		# i ~ table_list
	print(" [@_T] ■■ [/csv_info_tama_RD.py] ==> [T_50] [table_list] [i_번째]"+ i +"[01. 파일 명]"+ i.strip() +"[CSV 파일 정보 확인 작업 중...] .....■■■■■■ ")
	...
	try :
		...
		print(" [@_T] ■ [/csv_info_tama_RD.py] ==> [T_50_6] [table_list] [i_번째]"+ i +"[01. 파일 명]"+ i.strip() )
