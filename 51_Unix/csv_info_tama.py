...
for i in table_list:    # i ~ table_list    
	spprint("\n[@_T] ■ [/csv_info_tama.py] ==> ■■■■■■ [T_50] [table_list] [i_번째]"+ i.strip() )
	...
	print("\n[@_T] ■■  [/csv_info_tama.py] ==> [T_61]  [table_list ■] [i_번째]"+ i +"[01. 파일명]"+ splited_str[0].strip() +"[ 07 실재 데이터 건수■]]"+ str(linereal_data_cnt_count) +"[04. 라인 수]"+ str(line_count) +"[05. 헤드 수]"+ str(head_count) +"[03. 용량 ■]"+ str(volume) +"[02. 파일명"+ str(crm_file_nm) ) 
