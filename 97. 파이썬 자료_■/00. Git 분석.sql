...
# git pull origin main		# 02. dev 브런치에서 올리기 ■
============================================================================================================-

1. ghtHub에 올리기 받아 오기 ●
$ git add .
$ git commit -m "Add to 77_실행_파일_만들기, 97. 파이썬 자료_■ 폴더 올리기[24.10.26(T_01)], by tamario]"; 	
$ git push 		# 소스 올리기 ■
$ git log --all --oneline  		# log 시각적으로 보기
==============================================================================================================  

$ git add .
$ git commit -m "Add to 97. 파이썬 자료_■ 폴더 올리기[24.10.26(T_01)], by tamario]"; 	
