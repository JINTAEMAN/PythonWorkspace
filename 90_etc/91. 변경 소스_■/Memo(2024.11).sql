...
■■■■■■■■■■■■■■■■■■■■■■ 2024.11.06(수) 작업 ■■■■■■■■■■■■■■■■■■
---> 07:00 ~ 17:30 ==> 미국 제47대 대통령 선거 개표(민주당 해리스, 공화당 트럼프[당선: 292명(54.27%)], 공화당 상하원 과반 확보
...
21:00 인터넷 서핑
21:15 수종 갤럭시탭 S6 라이트 10.4 액정 깨짐(실내 자전거 타다가 떨어뜨렸다고 함)
23:00 취침
============================================================================================================== 
...
1. 파일 - 기본설정 - 바로 가기 키
 1) 바로 가기 키: 터미널 ==> 검색
   가. 보기: 터미널 토글, 키 바인딩: Ctrl + ' --> 키 바인딩 변경 클릭 
   나. 원하는 키 조합을 누르고 <Eter>키를  누르세요.
    ==> Ctrl + `(백틱)   ==> Eter 누룸
==> Ctrl + `(백틱)  터미널 열기/닫기
============================================================================================================== 
